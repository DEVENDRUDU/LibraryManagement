...
@WebServlet("/addbooksbylibrarian")
public class AddBooksByLibrarian extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String author=request.getParameter("author");
				...
				if(no==null || no.equals("") || title==null || title.equals("") || author==null || author.equals("") ) {
					...
					getServletContext().getRequestDispatcher("/addbooksbylibrarian.jsp").include(request, response);
				} else {
					int totalcopies=Integer.parseInt(no);
						...
						if(i!=0)
						{
							...
							getServletContext().getRequestDispatcher("/addbooksbylibrarian.jsp").forward(request, response);
						}else {
